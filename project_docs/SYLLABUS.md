...
### Chapter 11 � Core Runtime & Deployment Files (`manage.py`, `django_project/settings.py`, `django_project/urls.py`, `django_project/asgi.py`, `django_project/wsgi.py`, `gunicorn.conf.py`, `Procfile`, `render.yaml`, `.smoke_test.py`)
